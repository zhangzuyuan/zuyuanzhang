...
function getAssistantLayout(viewportWidth: number): AssistantLayout {
  // 小手机
  ...
  return {
    ...
    dialogBottom: 205,
    miniBubbleLeft: 28,
    miniBubbleBottom: 235,
    modelScale: BASE_MODEL_SCALE,
    modelXRatio: 0.20,
    modelYRatio: 0.50,
  };
}
...
//   % 监听窗口变化的 useEffect，放在别的 useEffect 旁边即可：
  useEffect(() => {
    const handleResize = () => {
